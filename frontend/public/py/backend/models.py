from runtime import MLP_MAX_ITER, N_JOBS
...
MODEL_REGISTRY = {
    "classification": {
        ...
        "random_forest": RandomForestClassifier(random_state=42, n_jobs=N_JOBS),
        "knn": KNeighborsClassifier(),
        "svm": SVC(random_state=42),
        "neural_network": MLPClassifier(
            hidden_layer_sizes=(64, 32), max_iter=MLP_MAX_ITER, random_state=42
        ),
    },
    "regression": {
